namespace Dotnet.Template.Server.Core.Configuration;
...
public static class AppConstants
{
    ...
    {
        /// <summary>
        /// Secret key that is holding the connection string to the database.
        /// </summary>
        public const string ConnectionStringKey = "TODO:";
    }
