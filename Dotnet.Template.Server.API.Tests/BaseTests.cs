...
using Dotnet.Template.Server.API.Tests.Helpers;
...
public abstract class BaseTests : IDisposable
{
    ...
    /// The configuration skips Auth0's Bearer token verifiction but still uses <see cref="Dotnet.Template.Server.API.Authorization.Configurations.AuthorizeAnyPolicyFilter"/>
